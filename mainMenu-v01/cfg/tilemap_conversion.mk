...
##  (4): Aditional options (aditional modifiers for cpct_tmx2csv)         ##
##                                                                        ##
...
##  * Parameter  (4) (Aditional options) is  optional and  generally not  ##
##    required.
############################################################################
...
$(eval $(call TMX2C,assets/prueba.tmx,g_nivel_1,src/levels/,hwpalette))