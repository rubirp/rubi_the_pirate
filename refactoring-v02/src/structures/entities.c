...
void setAction(T_Entity *ent, E_EntityStatus newstatus) {
	...
	switch (newstatus) {
		case ES_IDLE:  
			anim->frames = (T_AnimFrame**)g_limpiadora_anim_Idle;
		...
		case ES_WALK_RIGHT:
		   anim->frames = (T_AnimFrame**)g_limpiadora_anim_WalkRight;
		break;  

		case ES_WALK_LEFT:
		   anim->frames = (T_AnimFrame**)g_limpiadora_anim_WalkLeft;
		break;

		case ES_WALK_UP:
		   anim->frames = (T_AnimFrame**)g_limpiadora_anim_WalkUp;
		break;  

		case ES_WALK_DOWN:
		   anim->frames = (T_AnimFrame**)g_limpiadora_anim_WalkDown;
		break; 
	}
